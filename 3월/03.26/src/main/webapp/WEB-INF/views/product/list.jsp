...
<h1 class="mt-4">Product List Page</h1>
<ol class="breadcrumb mb-4">
	<li class="breadcrumb-item"><a href="/product/list">목록</a></li>
	<li class="breadcrumb-item"><a href="/product/add">등록</a></li>
</ol>
...
<div class="card mb-4">
	<div class="card-body">
		...
		<table class="table table-hover">
            ...
            <tbody>
            	<c:forEach items="${res.dtoList}" var="product">
                <tr>
                    <td>${product.pno }</td>
                    <td>
                    	<img src='/files/s_${product.fileName}'>
                    	<a href="/product/read/${product.pno}${requestDTO.pageLink}">
                    	${product.pname }
                    	</a>
                    </td>
                    <td>${product.price }</td>
		...
		<div class="container mt-3">
			...
			<ul class="pagination justify-content-center">
				...
				<c:if test="${res.prev }">
				<li class="page-item">
					<a class="page-link" href="/product/list?page=${res.start -1}${requestDTO.link}">Previous</a>
				</li>
				</c:if>
				...
				<li class="page-item ${res.page == num ?'active':'' }">
					<a class="page-link" href="/product/list?page=${num}${requestDTO.link}">${num }</a>
				</li>
				</c:forEach>
				
				<c:if test="${res.next }">
				<li class="page-item">
					<a class="page-link" href="/product/list?page=${res.end + 1}${requestDTO.link}">Next</a>
				</li>
				</c:if>
