...
<div class="container mt-5">
	<div class="card shadow-lg">
		...
		<div class="card-body">
			...
			<!-- 제목 입력 -->
			<div class="mb-3">
				<label for="pname" class="form-label">상품명</label> <input type="text"
			...
			<div class="mb-3">
				...
				<textarea class="form-control" name="pdesc" rows="5"
					placeholder="내용을 입력하세요" readonly>${product.pdesc}</textarea>
			</div>
			...
			<div class="text-center">
				<a href="/product/list${requestDTO.pageLink}"
					...
					href="/product/modify/${product.pno}${requestDTO.pageLink}"
