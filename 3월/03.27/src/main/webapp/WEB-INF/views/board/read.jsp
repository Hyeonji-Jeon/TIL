    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                value="${board.title}" placeholder="제목을 입력하세요" readonly>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="content" rows="5" 
                 placeholder="내용을 입력하세요" readonly>${board.content}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                value="${board.writer}" placeholder="작성자 이름" readonly>
            </div>
	...
	if(dtoList){
		replyStrArr = dtoList.map(replyDTO => `
			<li class="list-group-item" data-rno=\${replyDTO.rno}>
		      ...
		      <div>작성 날짜: \${replyDTO.replyDate}</div>
			</li>
	    `)
	}	
