...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = 1600905622L;
    ...
    public final NumberPath<Long> itemTotalPrice = createNumber("itemTotalPrice", Long.class);
    ...
    public final StringPath selectedOptions = createString("selectedOptions");
