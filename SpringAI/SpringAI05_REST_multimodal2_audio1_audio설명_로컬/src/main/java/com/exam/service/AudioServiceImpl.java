...
public class AudioServiceImpl implements AudioService {
	...
	public AudioServiceImpl(OpenAiAudioTranscriptionModel transcriptionModel) {
	...
	public String describeAudio() {
			...
			OpenAiAudioApi.TranscriptResponseFormat responseFormat = OpenAiAudioApi.TranscriptResponseFormat.VTT; // JSON, VTT( '시간범위: 문장' 포맷 )
			...
			AudioTranscriptionPrompt transcriptionRequest = new AudioTranscriptionPrompt(new ClassPathResource("/audio/안녕하세요좋은아침입니다.mp3"));
